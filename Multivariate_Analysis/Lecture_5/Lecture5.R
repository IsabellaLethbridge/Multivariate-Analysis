...
sweat <- read.table("Lecture_5/T5-1.DAT")
head(sweat)
...
door_closed <- read.table('Lecture_5/T4-1.DAT')
door_open <- read.table('Lecture_5/T4-5.DAT')
...
## Repeated measures
dental <- read.table('Lecture_5/T6_16_DENTAL.DAT')
head(dental, 12)
